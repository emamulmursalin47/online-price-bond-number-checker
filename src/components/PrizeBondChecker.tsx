...
const PrizeBondChecker = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-900 to-blue-700 w-[800px] py-8 md:py-16">
        <motion.div
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Prize Bond Checker Pro
          </h1>
          <p className="text-lg md:text-xl mb-8">
            Instantly verify your winning numbers with our professional checking
            tool
          </p>
          ...
          <AnimatePresence mode="wait">
            {activeTab === "checker" ? (
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                exit={{ opacity: 0, x: -20 }}
                className="bg-white rounded-lg shadow-lg p-4 md:p-6 border-l-4 border-blue-600 w-11]"
              >
                <h3 className="text-xl font-bold mb-6">
                  How to Use the Prize Bond Checker
                </h3>
                ...
                <div className="space-y-6">
                  ...
                  >
                    <h4 className="text-lg font-medium mb-2">
                      1. Enter Your Bond Numbers
                    </h4>
                    <p className="text-gray-600 mb-2">
                      Input your prize bond numbers in the first field,
                      separated by commas.
                    </p>
                    <Alert>
                  ...
                  >
                    <h4 className="text-lg font-medium mb-2">
                      2. Enter Draw Numbers
                    </h4>
                    <p className="text-gray-600">
                      Input the winning numbers from the draw in the second
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      Click the "Check Numbers" button to see if you have any
                      winning bonds. The results will show:
                    </p>
