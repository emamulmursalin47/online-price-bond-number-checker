  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta
          name="keywords"
          content="prize bond, prize bond check online, prize bond draw 114, 113th prize bond draw, 110th prize bond draw, 109th prize bond draw, bangladesh bank prize bond, 108th prize bond draw, 112th prize bond draw, prize bond draw, prize bond draw 2024, premium prize bond checker, prize checker premium bond, prize bond news, prize bond list 750 online check, prize bond 1500, prize bond list 2024 online check, prize bond 1500 list 2024 pdf download"
        />
      </Helmet>
      ...
      >
        <div className="container mx-auto px-4 py-3 md:py-4">
          <div className="flex items-center">
            ...
            <span className="text-lg md:text-2xl font-bold text-white">Prize Bond Pro</span>
          </div>
        </div>
      </motion.nav>

      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-900 to-blue-700 w-full py-8 md:py-16">
        <motion.div
        ...
        >
          <h1 className="text-2xl md:text-4xl font-bold mb-4">Prize Bond Checker Pro</h1>
          <p className="text-base md:text-xl mb-6 md:mb-8">
            Instantly verify your winning numbers with our professional checking tool
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-2 md:gap-4 flex-wrap">
            <motion.span
              whileHover={{ scale: 1.05 }}
              className="bg-white/10 px-3 py-1 md:px-4 md:py-2 rounded-full flex items-center justify-center text-sm md:text-base"
            >
      ...
      <div className="container mx-auto px-4 py-6 md:py-8">
        ...
        <div className="flex space-x-4 border-b border-gray-200 mb-6 overflow-x-auto">
          <motion.button
            ...
            className={`px-3 py-2 font-medium whitespace-nowrap text-sm md:text-base ${
              activeTab === "checker" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500"
            }`}
          >
            <div className="flex items-center">
          ...
          <motion.button
            ...
            className={`px-3 py-2 font-medium whitespace-nowrap text-sm md:text-base ${
              activeTab === "instructions" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500"
            }`}
          >
            <div className="flex items-center">
          ...
          <AnimatePresence mode="wait">
            {activeTab === "checker" ? (
              ...
              >
                <div className="mb-4 md:mb-6">
                  ...
                  <p className="text-xs md:text-sm text-gray-500 mt-1">
                    Enter bond numbers separated by commas
                  </p>
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={checkWinner}
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white font-medium py-2 md:py-3 px-4 rounded-lg text-sm md:text-base"
                >
                ...
                <AnimatePresence>
                  {results && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -20 }}
                      className="mt-4 md:mt-6 bg-white rounded-lg border border-gray-200"
                    >
                      <div className="p-3 md:p-4">
                        <h3 className="text-base md:text-lg font-medium mb-3 md:mb-4">Results</h3>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                exit={{ opacity: 0, x: -20 }}
                className="bg-white rounded-lg shadow-lg p-4 md:p-6 border-l-4 border-blue-600"
              >
                <h3 className="text-lg md:text-xl font-bold mb-4 md:mb-6">How to Use the Prize Bond Checker</h3>
                <div className="space-y-4 md:space-y-6">
                  <motion.div
                    ...
                    transition={{ delay: 0.1 }}
                  >
                    <h4 className="text-base md:text-lg font-medium mb-2">1. Enter Your Bond Numbers</h4>
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.2 }}
                  >
                    <h4 className="text-base md:text-lg font-medium mb-2">2. Enter Draw Numbers</h4>
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.3 }}
                  >
                    <h4 className="text-base md:text-lg font-medium mb-2">3. Check Results</h4>
                    <p className="text-gray-600 text-sm md:text-base">
      ...
      <motion.footer
        ...
        className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-6 mt-8 md:mt-12"
      >
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -50 }}
            className="fixed top-2 right-2 left-2 md:top-4 md:right-4 md:left-auto bg-white rounded-lg shadow-lg p-3 md:p-4 max-w-xs md:max-w-sm text-sm md:text-base"
          >
            <div className="flex items-center">
              <Trophy className="h-5 w-5 text-blue-600 mr-2" />
              <p className="text-gray-800 break-words">{toastMessage}</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
